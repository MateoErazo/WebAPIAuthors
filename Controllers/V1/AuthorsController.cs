...
namespace WebAPIAuthors.Controllers.V1
{
    ...
    public class AuthorsController : ControllerBase
    {
        ...
        [HttpGet("all", Name = "getAllAuthorsV1")]
        ...
        [ServiceFilter(typeof(HATEOASAuthorFilterAttribute))]
        [HttpGet("{id:int}", Name = "getSingleAuthorByIdV1")]
        ...
        public async Task<ActionResult> AddNewAuthor(AuthorCreationDTO authorCreationDTO)
        {
            ...
            return CreatedAtRoute("getSingleAuthorByIdV1", new { id = author.Id }, authorDTO);
        }
        ...
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme, Policy = "isAdmin")]
        [HttpPut("{id:int}", Name = "updateCompleteAuthorV1")]
