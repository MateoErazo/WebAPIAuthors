...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230913175739_automapper')
BEGIN
...
BEGIN
    ...
    VALUES (N'20230913175739_automapper', N'7.0.11');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20230917015745_SystemIdentity')
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20230917015745_SystemIdentity', N'7.0.11');
END;
GO
